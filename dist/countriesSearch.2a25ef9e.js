...
})({"8meWU":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "d2e51bc22a25ef9e";
"use strict";
...
function injectInformationTextCountriesData() {
    fetchPeculiarCountryData().then((data)=>{
        ...
        if (data[0].languages.length === 3) string = `They speak ${first.nativeName}, ${second.nativeName} and ${third.nativeName}`;
        if (data[0].languages.length === 2) string = `They speak ${first.nativeName} and ${second.nativeName}`;
...
//# sourceMappingURL=countriesSearch.2a25ef9e.js.map
